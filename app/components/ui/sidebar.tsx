		...
		<SidebarContext.Provider value={contextValue}>
			<TooltipProvider delayDuration={0}>
				<div
					...
					className={cn("group/sidebar-wrapper flex w-full overflow-hidden has-[[data-variant=inset]]:bg-sidebar", className)}
					ref={ref}
					{...props}
				>
					{children}
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
	...
	if (collapsible === "none") {
		return (
			<div
				className={cn("flex h-full w-(--sidebar-width) flex-col bg-sidebar font-sans text-sidebar-foreground", className)}
				ref={ref}
				{...props}
			>
				{children}
